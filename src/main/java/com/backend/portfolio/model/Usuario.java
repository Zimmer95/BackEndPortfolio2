...
public class Usuario implements UserDetails{
    ...
    public Usuario(Long id, String username, String password, String nombre, String apellido, String email, String dni, String telefono, String sobre_mi, String fotoPerfil) {
        this.id = id;
